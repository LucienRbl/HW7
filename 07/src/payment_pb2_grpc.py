...
class PaymentServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.ListPayments = channel.unary_unary(
                ...
                response_deserializer=payment__pb2.PaymentList.FromString,
...
def add_PaymentServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'ListPayments': grpc.unary_unary_rpc_method_handler(
                    ...
                    response_serializer=payment__pb2.PaymentList.SerializeToString,
            ),
...
class PaymentService(object):
    ...
    def ListPayments(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            payment__pb2.PaymentList.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
